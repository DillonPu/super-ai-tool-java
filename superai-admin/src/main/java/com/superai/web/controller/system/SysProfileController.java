...
import com.superai.common.utils.file.MimeTypeUtils;
import com.superai.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(SuperAiConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
